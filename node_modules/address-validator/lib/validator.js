...
(function() {
  var Address, HttpsProxyAgent, _, addressMatch, defaultMatchType, matchType, matchUnknownType, options, request;
  ...
  exports.Address = Address = (function() {
    ...
    function Address(address, isObject, generated) {
      var city, colloquialArea, country, countryAbbr, getComponent, location, postalCode, postalCodePrefix, ref, ref1, ref10, ref11, ref12, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, state, stateAbbr, street, streetAbbr, streetNum, sublocality, x;
      ...
      if (_.isObject(address)) {
        ...
        if (address.address_components) {
          ...
          ref4 = getComponent('street_number'), x = ref4[0], streetNum = ref4[1];
          ref5 = getComponent('route'), streetAbbr = ref5[0], street = ref5[1];
          ...
          ref9 = getComponent('postal_code'), postalCode = ref9[0], x = ref9[1];
          ref10 = getComponent('postal_code_prefix'), postalCodePrefix = ref10[0], x = ref10[1];
          ref11 = getComponent('colloquial_area'), colloquialArea = ref11[0], x = ref11[1];
          ref12 = getComponent('sublocality'), sublocality = ref12[0], x = ref12[1];
          address = {
